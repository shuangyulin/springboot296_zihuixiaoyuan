...
var centerMenu = [
    ...
    ,{
        name: '计算机专业相关的软件收藏',
        url: '../jisuanjizhuanyeruanjianCollection/list.html'
    }
    ,{
        name: '课程收藏',
    ...
    ,{
        name: '音乐收藏',
        url: '../yinyueCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '计算机专业相关的软件',
        url: './pages/jisuanjizhuanyeruanjian/list.html'
    },
    {
        name: '课程',
    ...
    {
        name: '音乐',
        url: './pages/yinyue/list.html'
    },

]

var adminurl =  "http://localhost:8080/zhihuixiaoyuan/admin/dist/index.html#/login";
