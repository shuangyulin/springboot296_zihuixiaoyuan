        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && role!= '老师'"  label="报修内容" prop="baoxiuContent">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="报修状态" prop="baoxiuTypes">
                        <el-select v-model="ruleForm.baoxiuTypes" :disabled="ro.baoxiuTypes" placeholder="请选择报修状态">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="报修状态" prop="baoxiuValue">
