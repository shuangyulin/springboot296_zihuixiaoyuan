...
public class SusheController {
    ...
    @Autowired
    private SusheRenruanService susheRenruanService;
    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        if(false)
            ...
            SusheRenruanEntity susheRenruanEntity = susheRenruanService.selectOne(new EntityWrapper<SusheRenruanEntity>().eq("yonghu_id", request.getSession().getAttribute("userId")));
            if(susheRenruanEntity != null){
                params.put("yonghuId",request.getSession().getAttribute("userId"));
                params.put("ids",Arrays.asList(new Integer[]{susheRenruanEntity.getId()}));
            }
        }
...
//                            susheEntity.setSusheAddress(data.get(0));                    //宿舍地址 要改的
