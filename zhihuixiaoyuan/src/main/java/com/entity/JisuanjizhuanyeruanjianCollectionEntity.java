...
public class JisuanjizhuanyeruanjianCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JisuanjizhuanyeruanjianCollectionEntity() {

	}

	public JisuanjizhuanyeruanjianCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "JisuanjizhuanyeruanjianCollection{" +
            "id=" + id +
            ", jisuanjizhuanyeruanjianId=" + jisuanjizhuanyeruanjianId +
            ", yonghuId=" + yonghuId +
            ", jisuanjizhuanyeruanjianCollectionTypes=" + jisuanjizhuanyeruanjianCollectionTypes +
