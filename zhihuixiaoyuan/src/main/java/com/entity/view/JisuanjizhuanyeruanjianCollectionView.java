...
public class JisuanjizhuanyeruanjianCollectionView extends JisuanjizhuanyeruanjianCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String jisuanjizhuanyeruanjianCollectionValue;
	...
	public JisuanjizhuanyeruanjianCollectionView() {

	}

	public JisuanjizhuanyeruanjianCollectionView(JisuanjizhuanyeruanjianCollectionEntity jisuanjizhuanyeruanjianCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, jisuanjizhuanyeruanjianCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getJisuanjizhuanyeruanjianCollectionValue() {
				return jisuanjizhuanyeruanjianCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setJisuanjizhuanyeruanjianCollectionValue(String jisuanjizhuanyeruanjianCollectionValue) {
				this.jisuanjizhuanyeruanjianCollectionValue = jisuanjizhuanyeruanjianCollectionValue;
			}
