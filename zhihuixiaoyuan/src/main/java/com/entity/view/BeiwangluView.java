...
public class BeiwangluView extends BeiwangluEntity implements Serializable {
	...
	public BeiwangluView(BeiwangluEntity beiwangluEntity) {
		try {
			...
			* 获取： 备忘录类型的值
			*/
			public String getBeiwangluValue() {
				return beiwangluValue;
			}
			/**
			* 设置： 备忘录类型的值
			*/
			public void setBeiwangluValue(String beiwangluValue) {
				this.beiwangluValue = beiwangluValue;
			}
