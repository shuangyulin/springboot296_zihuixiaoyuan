...
public class SusheRenruanView extends SusheRenruanEntity implements Serializable {
	...
	public SusheRenruanView() {

	}

	public SusheRenruanView(SusheRenruanEntity susheRenruanEntity) {
		try {
			BeanUtils.copyProperties(this, susheRenruanEntity);
